...
public class SideBar extends View {
			...
			if (currentTouchIndex != preChoosenAlphabetIndex) {
				...
				if (currentTouchIndex >= 0 && currentTouchIndex < alphabet.length) {
					...
					if(currentTouchIndex == 0){
						mBackToListTopListener.backtoTop(true);
					}
	...
	private BackToListTopListener mBackToListTopListener = null;
	
	public void setBackToListTopListener(
			BackToListTopListener BackToListTopListener) {
		this.mBackToListTopListener = BackToListTopListener;
	}
	
	public interface BackToListTopListener {
